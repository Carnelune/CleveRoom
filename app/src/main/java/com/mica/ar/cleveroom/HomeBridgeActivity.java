...
public class HomeBridgeActivity extends Activity implements AdapterView.OnItemClickListener {
    ...
    private PHSDKListener listener = new PHSDKListener() {
        ...
        public void onConnectionResumed(PHBridge bridge) {
            if (HomeBridgeActivity.this.isFinishing())
                return;
    ...
    public void doBridgeSearch() {
        WizardAlertDialog.getInstance().showProgressDialog(R.string.search_progress, HomeBridgeActivity.this);
        PHBridgeSearchManager sm = (PHBridgeSearchManager) phHueSDK.getSDKService(PHHueSDK.SEARCH_BRIDGE);
    ...
    public void startMainActivity() {
        Intent intent = new Intent(getApplicationContext(), ListLightActivity.class);
